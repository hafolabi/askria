...
function SignUp() {
  ...
  const handleSubmit = () => {
    ...
    // You can perform any additional logic here, like saving the data to a database, etc.
  };
  ...
  const renderModal = () => {
    switch (selectedOption) {
      ...
      case "Video question":
        return  <VideoBasedQuestionsModal setSelectedOption={setSelectedOption}/>;
       case "Dropdown":
			...
			<div className='flex bg-[#F9FAFF]'>
				...
				<main className='flex-1 h-screen overflow-x-hidden overflow-y-scroll'>
					...
					<section className='p-5'>
						...
						<PersonalInformation personalData={personalData} setPersonalData={setPersonalData} handleChangeInput={handleChangeInput} setSelectQmodal={setSelectQmodal}/>
						...
						<div className='bg-white w-2/5 mt-4 shadow rounded-lg overflow-hidden'>
							...
							<div className='mt-8 px-6'>
								...
								<button onClick={() => setSelectQmodal(true)} className='flex items-center font-semibold ml-2 mb-5'>
                    ...
                    {
                     selectQmodal   && (
                            <SelectQuestionsModal handleChange={handleChange} setSelectQmodal={setSelectQmodal}/>
                        )
                    }
                     {renderModal()}
