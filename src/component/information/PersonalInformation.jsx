...
function PersonalInformation({personalData, handleChangeInput, setSelectQmodal}) {
	return (
		<div className='bg-white w-2/5 mt-4 shadow rounded-lg overflow-hidden'>
			...
			<button className='flex items-center font-semibold ml-4 mb-5' onClick={()=> setSelectQmodal(true)}>
